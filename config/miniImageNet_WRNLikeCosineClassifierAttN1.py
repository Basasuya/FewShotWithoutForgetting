...
networks = {}
net_optionsF = {'userelu': False, 'depth': 28, 'widen_factor' : 10}
pretrainedF = './experiments/miniImageNet_WRNLikeCosineClassifier/feat_model_net_epoch*.best'
networks['feat_model'] = {'def_file': 'architectures/WideResNet.py', 'pretrained': pretrainedF, 'opt': net_optionsF, 'optim_params': None}

net_optim_paramsC = {'optim_type': 'sgd', 'lr': 0.01, 'momentum':0.9, 'weight_decay': 5e-4, 'nesterov': True, 'LUT_lr':[(10*2, 0.01),(20*2, 0.006),(25*2, 0.0012),(30*2, 0.00024)]}
pretrainedC = './experiments/miniImageNet_WRNLikeCosineClassifier/classifier_net_epoch*.best'
net_optionsC = {'classifier_type': 'cosine', 'weight_generator_type': 'attention_based', 'nKall': nKbase, 'nFeat': 640, 'scale_cls': 10, 'scale_att': 10.0}
